...
namespace EjemploMVC.Controllers
{
    public class ProyectoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Descripcion,Estado,FechaInicio,FechaFin,Presupuesto")] Proyecto proyecto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Descripcion,Estado,FechaInicio,FechaFin,Presupuesto")] Proyecto proyecto)
        {
            if (ModelState.IsValid)
            {
